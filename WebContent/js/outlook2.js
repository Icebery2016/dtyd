...
function InitLeftMenu() {
	var _menus = {"menus":[
							{"menuid":"1","icon":"icon-sys","menuname":"项目管理",
							    "menus":[
										{"menuid":"13","menuname":"员工信息","icon":"icon-class","url":"tree1.action"},
										{"menuid":"14","menuname":"菜单","icon":"icon-role","url":"WEB-INF/jsp/menu1/class.html"},
							...
							{"menuid":"3","icon":"icon-sys","menuname":"项目设计",
								"menus":[
										{"menuid":"22","menuname":"菜单","icon":"icon-nav","url":"demo1.html"}
							]},
							{"menuid":"6","icon":"icon-sys","menuname":"",
								"menus":[]
								}
					    ]};
